...
(function (T, O) {
    ...
    O(n, "Core/Globals.js", [], function () {
        var f = "undefined" !== typeof T ? T : "undefined" !== typeof window ? window : {}, a = f.document,
            ...
            n = /(edge|msie|trident)/i.test(S) && !f.opera, G = -1 !== S.indexOf("Firefox"),
            C = -1 !== S.indexOf("Chrome"), J = G && 4 > parseInt(S.split("Firefox/")[1], 10);
        return {
            product: "Highcharts",
            version: "8.2.0",
    ...
    O(n, "Core/Utilities.js", [n["Core/Globals.js"]], function (f) {
        function a(b, c, e, d) {
            ...
            var w = I(b), g = w ? z + " #" + b + ": www.highcharts.com/errors/" + b + "/" : b.toString();
            z = function () {
                if (c) throw Error(g);
        ...
        function S() {
            var b, c = arguments, e = {}, d = function (b, c) {
                "object" !== typeof b && (b = {});
                U(c, function (e, z) {
        ...
        function C(b, c) {
            ...
            for (b = e.pop(); "undefined" !== typeof b && "undefined" !== typeof c && null !==
            c;) c = c[b], b = e.pop();
            return c
        }
        ...
        var L = function () {
            ...
            b.prototype.dSetter = function () {
                var b = this.paths, c = b && b[0];
                b = b && b[1];
                var e = [], d = this.now || 0;
                if (1 !== d && c && b) if (c.length === b.length && 1 > d) for (var z = 0; z < b.length; z++) {
            ...
            b.prototype.update = function () {
                var b = this.elem, c = this.prop, e = this.now, d = this.options.step;
            ...
            b.prototype.run = function (b, c, e) {
                var d = this, z = d.options, w = function (b) {
            ...
            b.prototype.step = function (b) {
                var c = +new Date, e = this.options, d = this.elem, z = e.complete, w = e.duration, g = e.curAnim;
            ...
            b.prototype.initPath = function (b, c, e) {
                ...
                var w = b.startX, g = b.endX;
                c = c && c.slice();
                e = e.slice();
                var h = b.isArea, k = h ? 2 : 1;
                if (!c) return [e, e];
                if (w && g) {
                    for (b = 0; b < w.length; b++) if (w[b] === g[0]) {
                        var P = b;
                        break
        ...
        var d = f.css = function (b, c) {
            ...
            var d = b[c];
            b[c] = function () {
                var b = Array.prototype.slice.call(arguments), c = arguments, z = this;
                z.proceed = function () {
            ...
            var d = "{", z = !1, w = [], g = /f$/, h = /\.([0-9])/,
                k = f.defaultOptions.lang, P = e && e.time || f.time;
            ...
            b = +b || 0;
            c = +c;
            var z = f.defaultOptions.lang, w = (b.toString().split(".")[1] || "").split("e")[0].length,
                g = b.toString().split("e");
            if (-1 === c) c = Math.min(w, 20); else if (!I(c)) c = 2; else if (c &&
                g[1] && 0 > g[1]) {
                var h = c + +g[1];
        ...
        var ja = f.addEvent = function (b, c, e, d) {
            ...
            if (H.createEvent && (b.dispatchEvent || b.fireEvent)) {
                ...
                void 0 === c && (c = []);
                void 0 === d && (d = []);
                var w = 0, g = 0, h = c.length + d.length;
    ...
    O(n, "Core/Color.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var S = a.isNumber, y = a.merge, n = a.pInt;
        a = function () {
            function a(f) {
                this.parsers = [{
    ...
    O(n, "Core/Renderer/SVG/SVGElement.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a, n) {
        var y = a.deg2rad, D = a.doc, G = a.hasTouch, C = a.isFirefox, J = a.noop, H = a.svg, v = a.SVG_NS, L = a.win,
            q = n.animate, K = n.animObject, E = n.attr, p = n.createElement, t = n.css, I = n.defined, u = n.erase,
            m = n.extend, h = n.fireEvent, l = n.isArray, k = n.isFunction, g = n.isNumber, d = n.isString, x = n.merge,
            r = n.objectEach, A = n.pick, N = n.pInt, B = n.stop, M = n.syncTimeout, R = n.uniqueKey;
        "";
        n = function () {
            function F() {
            ...
            F.prototype.attr = function (e, c, b, d) {
                var z = this.element, g, h = this, k, l, m = this.symbolCustomAttribs;
            ...
            F.prototype.complexColor = function (e, c, b) {
                var d = this.renderer, w, g, k, m, p, B, t, A, u, M, Q = [], F;
            ...
            F.prototype.css = function (e) {
                var c = this.styles, b = {}, d = this.element, w = "", g = !c,
            ...
            F.prototype.destroy = function () {
                var e = this, c = e.element || {}, b = e.renderer,
                    d = b.isSVG && "SPAN" === c.nodeName && e.parentGroup || void 0, w = c.ownerSVGElement;
            ...
            F.prototype.fadeOut = function (e) {
                var c = this;
                c.animate({opacity: 0}, {
                    duration: A(e, 150), complete: function () {
                        c.attr({y: -9999}).hide()
                    }
                })
            };
            ...
            F.prototype.getBBox = function (e, c) {
                var b, d = this.renderer, w = this.element, g = this.styles, h = this.textStr, l = d.cache,
                    r = d.cacheKeys, x = w.namespaceURI === this.SVG_NS;
            ...
            F.prototype.setTextPath = function (e, c) {
                var b = this.element, d = {textAnchor: "text-anchor"},
                    w = !1, k = this.textPathWrapper, h = !k;
            ...
            F.prototype.shadow = function (e, c, b) {
                var d = [], g = this.element, k = !1, h = this.oldShadowOptions;
                var l = {
                    color: "#000000",
            ...
            F.prototype.updateTransform = function () {
                var e = this.translateX || 0, c = this.translateY || 0, b = this.scaleX, d = this.scaleY,
                    g = this.inverted, k = this.rotation, h = this.matrix, l = this.element;
    ...
    O(n, "Core/Renderer/SVG/SVGLabel.js", [n["Core/Renderer/SVG/SVGElement.js"],
        ...
        return function (a) {
            ...
            v.prototype.getBBox =
                function () {
                    var a = this.bBox, f = this.padding;
            ...
            v.prototype.on = function (a, q) {
                var v = this, E = v.text, p = E && "SPAN" === E.element.tagName ? E : void 0;
                if (p) {
                    var t = function (t) {
            ...
            v.prototype.updateBoxSize = function () {
                var a = this.text.element.style, f = {}, H = this.padding, E = this.paddingLeft,
            ...
            v.prototype.updateTextPadding =
                function () {
                    var a = this.text, f = this.baseline ? 0 : this.baselineOffset, v = this.paddingLeft + this.padding;
    ...
    O(n, "Core/Renderer/SVG/SVGRenderer.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Renderer/SVG/SVGLabel.js"], n["Core/Utilities.js"]], function (f, a, n, y, D) {
        var G = D.addEvent, C = D.attr, J = D.createElement, H = D.css, v = D.defined, L = D.destroyObjectProperties,
            q = D.extend, K = D.isArray, E = D.isNumber, p = D.isObject, t = D.isString, I = D.merge, u = D.objectEach,
            m = D.pick, h = D.pInt, l = D.splat, k = D.uniqueKey, g = a.charts, d = a.deg2rad, x = a.doc,
            r = a.isFirefox, A = a.isMS, N = a.isWebKit;
        D =
            a.noop;
        var B = a.svg, M = a.SVG_NS, R = a.symbolSizes, F = a.win, e = function () {
            ...
            c.prototype.definition = function (b) {
                function c(b, d) {
                    ...
                    l(b).forEach(function (b) {
                        var w = e.createElement(b.tagName), z = {};
                        u(b, function (b, c) {
            ...
            c.prototype.buildText = function (b) {
                var c = b.element, e = this, d = e.forExport, g = m(b.textStr, "").toString(),
                    k = -1 !== g.indexOf("<"), l = c.childNodes, r, p = C(c, "x"), a = b.styles, A = b.textWidth,
                    I = a && a.lineHeight, Q = a && a.textOutline, f = a && "ellipsis" === a.textOverflow,
                    F = a && "nowrap" === a.whiteSpace, N = a && a.fontSize, q, E = l.length;
                ...
                if (J !== b.textCache) {
                    ...
                    k || Q || f || A || -1 !== g.indexOf(" ") && (!F ||
                        ...
                        h.forEach(function (g) {
                            if ("" !== g || 1 === h.length) {
                                var l = {}, m = x.createElementNS(e.SVG_NS, "tspan"), P, a;
                                ...
                                if (" " !== g) {
                                    ...
                                    if (A) {
                                        ...
                                        }); else if (l) for (; Q.length;) Q.length && !F && 0 < t && (m = x.createElementNS(M, "tspan"), C(m, {
                                            dy: a,
                                            x: p
            ...
            c.prototype.button = function (b,
                                           c, e, d, g, k, h, l, r, m) {
                var w = this.label(b, c, e, r, void 0, void 0, m, void 0, "button"), z = 0, x = this.styledMode;
                b = (g = g ? I(g) : g) && g.style || {};
            ...
            c.prototype.setSize = function (b, c, e) {
                var d = this.alignedObjects, g = d.length;
                this.width = b;
                this.height = c;
                for (this.boxWrapper.animate({width: b, height: c}, {
                    step: function () {
                ...
                if (P) {
                    ...
                    ["width", "height"].forEach(function (b) {
                        a[b + "Setter"] = function (b, c) {
                            var e =
                                {}, d = this["img" + c], g = "width" === c ? "translateX" : "translateY";
                            this[c] = b;
            ...
            c.prototype.clipRect = function (b, c, e, d) {
                var g = k() + "-", w = this.createElement("clipPath").attr({id: g}).add(this.defs);
            ...
            c.prototype.text = function (b, c,
                ...
                d || (b.xSetter = function (b, c, e) {
                    var d = e.getElementsByTagName("tspan"), g = e.getAttribute(c), k;
        ...
        e.prototype.symbols = {
            circle: function (c, b, e, d) {
                return this.arc(c + e / 2, b + d / 2, e / 2, d / 2, {start: .5 * Math.PI, end: 2.5 * Math.PI, open: !1})
                ...
                var k = [];
                if (g) {
                    var h = g.start || 0, w = g.end || 0, z = g.r || e;
                    e = g.r || d || e;
                    var l = .001 > Math.abs(w - h - 2 * Math.PI);
                    w -= .001;
                    d = g.innerR;
                    l = m(g.open, l);
                    var r = Math.cos(h), x = Math.sin(h),
                        a = Math.cos(w), P = Math.sin(w);
                ...
                var k = Math.min(g && g.r || 0, e, d), h = k + 6, w = g && g.anchorX || 0;
                g = g && g.anchorY || 0;
                var l = [["M", c + k, b], ["L", c + e - k, b], ["C", c + e, b, c + e, b, c + e, b + k], ["L", c + e, b + d - k], ["C", c + e, b + d, c + e, b + d, c + e - k, b + d], ["L", c + k, b + d], ["C", c, b + d,
                    c, b + d, c, b + d - k], ["L", c, b + k], ["C", c, b, c, b, c + k, b]];
    ...
    O(n, "Core/Renderer/HTML/HTML.js", [n["Core/Globals.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Renderer/SVG/SVGRenderer.js"], n["Core/Utilities.js"]], function (f, a, n, y) {
        var D = y.attr, G = y.createElement, C = y.css, J = y.defined, H = y.extend, v = y.pick, L = y.pInt,
            q = f.isFirefox, K = f.isMS, E = f.isWebKit, p = f.win;
        H(a.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, p = this.element, u = this.translateX || 0, m = this.translateY || 0,
                        h = this.x || 0, l = this.y || 0, k = this.textAlign ||
                            "left", g = {left: 0, center: .5, right: 1}[k], d = this.styles, x = d && d.whiteSpace;
                    ...
                    if ("SPAN" === p.tagName) {
                        ...
                        var r = this.textWidth && L(this.textWidth),
                            A = [d, k, p.innerHTML, this.textWidth, this.textAlign].join(), f;
        ...
        H(n.prototype, {
            getTransformKey: function () {
                ...
                var m = this.createElement("span"), h = m.element, l = m.renderer, k = l.isSVG, g = function (d, g) {
                    ...
                    if (this.parentGroup = d) {
                        ...
                        if (!a) {
                            ...
                            r.reverse().forEach(function (d) {
                                ...
                                a = d.div = d.div || G("div", l ? {className: l} : void 0, {
                                    position: "absolute",
    ...
    O(n, "Core/Axis/Tick.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.clamp, y = a.correctFloat, D = a.defined, G = a.destroyObjectProperties, C = a.extend,
            J = a.fireEvent, H = a.isNumber, v = a.merge, L = a.objectEach, q = a.pick, K = f.deg2rad;
        a = function () {
            ...
            a.prototype.addLabel = function () {
                var a = this, t = a.axis, f = t.options, u = t.chart, m = t.categories, h = t.logarithmic, l = t.names,
                    k = a.pos, g = q(a.options && a.options.labels, f.labels), d = t.tickPositions, x = k === d[0],
                    r = k === d[d.length - 1];
                ...
                D(A) || a.movedLabel ? A && A.textStr !== f && !m && (!A.textWidth || g.style && g.style.width || A.styles.width || A.css({width: null}), A.attr({text: f}), A.textPxLength = A.getBBox().width) : (a.label = A = a.createLabel({
                    x: 0,
                    y: 0
                }, f, g), a.rotation = 0)
            };
            ...
            a.prototype.getLabelPosition =
                function (a, t, f, u, m, h, l, k) {
                    var g = this.axis, d = g.transA,
                        x = g.isLinked && g.linkedParent ? g.linkedParent.reversed : g.reversed, r = g.staggerLines,
                        p = g.tickRotCorr || {x: 0, y: 0}, I = m.y,
            ...
            a.prototype.handleOverflow = function (a) {
                var p = this.axis, f = p.options.labels, u = a.x, m = p.chart.chartWidth, h = p.chart.spacing,
                    l = q(p.labelLeft, Math.min(p.pos, h[3]));
                h = q(p.labelRight, Math.max(p.isRadial ?
                    0 : p.pos + p.len, m - h[1]));
                var k = this.label, g = this.rotation,
                    d = {left: 0, center: .5, right: 1}[p.labelAlign || k.attr("align")], x = k.getBBox().width,
                    r = p.getSlotWidth(this), A = r, N = 1, B, M = {};
                if (g || "justify" !== q(f.overflow, "justify")) 0 > g && u - d * x < l ? B = Math.round(u / Math.cos(g * K) - l) : 0 < g && u + d * x > h && (B = Math.round((m - u) / Math.cos(g * K))); else if (m = u + (1 - d) * x, u - d * x < l ? A = a.x + A * (1 - d) - l : m > h && (A = h - a.x + A * d, N = -1), A = Math.min(r, A), A < r && "center" === p.labelAlign && (a.x += N * (r - A - d * (r - Math.min(x, A)))), x > A || p.autoRotation && (k.styles || {}).width) B =
                    A;
            ...
            a.prototype.moveLabel = function (a, t) {
                var p = this, f = p.label, m = !1, h = p.axis, l = h.reversed;
            ...
            a.prototype.renderGridLine = function (a, t, f) {
                var p =
                        this.axis, m = p.options, h = this.gridLine, l = {}, k = this.pos, g = this.type,
                    d = q(this.tickmarkOffset, p.tickmarkOffset), x = p.chart.renderer, r = g ? g + "Grid" : "grid",
                    A = m[r + "LineWidth"], N = m[r + "LineColor"];
                m = m[r + "LineDashStyle"];
            ...
            a.prototype.renderMark = function (a, t, f) {
                var p = this.axis, m = p.options, h = p.chart.renderer, l = this.type, k = l ? l + "Tick" : "tick",
                    g = p.tickSize(k), d = this.mark, x = !d, r = a.x;
                a = a.y;
            ...
            a.prototype.renderLabel = function (a, f, I, u) {
                ...
                var x = !0, r = a.x;
                a = a.y;
                k && H(r) && (k.xy = a = this.getLabelPosition(r, a, k, h, g, m, u, d), this.isFirst && !this.isLast && !q(l.showFirstLabel, 1) || this.isLast && !this.isFirst && !q(l.showLastLabel, 1) ? x = !1 : !h || g.step || g.rotation || f || 0 === I || this.handleOverflow(a), d && u % d && (x = !1), x && H(a.y) ? (a.opacity = I, k[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel =
                    !1) : (k.attr("y", -9999), this.isNewLabel = !0))
            };
            a.prototype.replaceMovedLabel = function () {
                var a = this.label, f = this.axis, q = f.reversed;
                if (a && !this.isNew) {
    ...
    O(n, "Core/Time.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.defined, y = a.error,
            D = a.extend, G = a.isObject, C = a.merge, J = a.objectEach, H = a.pad, v = a.pick, L = a.splat,
            q = a.timeUnits, K = f.win;
        a = function () {
            function a(a) {
                this.options = {};
            ...
            a.prototype.get = function (a, f) {
                if (this.variableTimezone || this.timezoneOffset) {
                    var p = f.getTime(), t = p - this.getTimezoneOffset(f);
                    f.setTime(t);
                    a = f["getUTC" + a]();
                    f.setTime(p);
                    return a
            ...
            a.prototype.dateFormat = function (a, t, q) {
                ...
                var m = this;
                p = new this.Date(t);
                var h = this.get("Hours", p), l = this.get("Day", p), k = this.get("Date", p), g = this.get("Month", p),
                    d = this.get("FullYear", p), x = f.defaultOptions.lang,
            ...
            a.prototype.getTimeTicks = function (a, f, I, u) {
                var m = this, h = [], l = {};
                var k = new m.Date(f);
                var g = a.unitRange, d = a.count || 1, x;
                u = v(u, 1);
                if (n(f)) {
    ...
    O(n, "Core/Axis/Axis.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Axis/Tick.js"], n["Core/Utilities.js"], n["Core/Options.js"]], function (f, a, n, y, D) {
        var G = y.addEvent, C = y.animObject, J = y.arrayMax, H = y.arrayMin, v = y.clamp, L = y.correctFloat,
            q = y.defined, K = y.destroyObjectProperties, E = y.error, p = y.extend, t = y.fireEvent, I = y.format,
            u = y.getMagnitude, m = y.isArray, h = y.isFunction, l = y.isNumber, k = y.isString, g = y.merge,
            d = y.normalizeTickInterval, x = y.objectEach, r = y.pick,
        ...
        y = function () {
            ...
            e.prototype.defaultLabelFormatter = function () {
                var c = this.axis, b = l(this.value) ? this.value :
                        NaN, e = c.chart.time, d = c.categories, g = this.dateTimeLabelFormat, k = R.lang,
                    h = k.numericSymbols;
                k = k.numericSymbolMagnitude || 1E3;
                var a = h && h.length, r = c.options.labels.format;
                c = c.logarithmic ? Math.abs(b) : c.tickInterval;
                var m = this.chart, x = m.numberFormatter;
                if (r) var f = I(r, this, m); else if (d) f = "" + this.value; else if (g) f = e.dateFormat(g, b); else if (a && 1E3 <= c) for (; a-- && "undefined" === typeof f;) e = Math.pow(k, a + 1), c >= e && 0 === 10 * b % e && null !== h[a] && 0 !== b && (f = x(b / e, -1) + h[a]);
                "undefined" === typeof f && (f = 1E4 <= Math.abs(b) ? x(b, -1) :
                    x(b, -1, void 0, ""));
                return f
            };
            e.prototype.getSeriesExtremes = function () {
                var c = this, b = c.chart, e;
            ...
            e.prototype.translate =
                function (c, b, e, d, g, k) {
                    var h = this.linkedParent || this, a = 1, w = 0, z = d ? h.oldTransA : h.transA;
                    d = d ? h.oldMin : h.min;
            ...
            e.prototype.getPlotLinePath = function (c) {
                ...
                var e = this, d = e.chart, g = e.left, k = e.top, h = c.old, a = c.value, m = c.translatedValue,
                    x = c.lineWidth, f = c.force, p, B, A, M, F = h && d.oldChartHeight || d.chartHeight,
                    u = h && d.oldChartWidth || d.chartWidth, q, N = e.transB;
            ...
            e.prototype.getMinorTickPositions = function () {
                var c = this.options, b = this.tickPositions, e = this.minorTickInterval, d = [],
                    g = this.pointRangePadding || 0, k = this.min - g;
                g = this.max + g;
                var h = g - k;
                if (h && h / e < this.len / 3) {
            ...
            e.prototype.adjustForMinRange = function () {
                var c = this.options, b = this.min, e = this.max, d = this.logarithmic, g, k, h, a, l;
            ...
            e.prototype.getClosest = function () {
                ...
                this.categories ? c = 1 : this.series.forEach(function (b) {
                    var e = b.closestPointRange, d = b.visible || !b.chart.options.chart.ignoreHiddenSeries;
                    !b.noSharedTooltip && q(e) && d && (c = q(c) ? Math.min(c, e) : e)
                });
                return c
            };
            e.prototype.nameToX = function (c) {
                var b = m(this.categories), e = b ? this.categories : this.names, d = c.options.x;
            ...
            e.prototype.setAxisTranslation = function (c) {
                var b = this, e = b.max - b.min, d = b.axisPointRange || 0, g = 0, h = 0, a = b.linkedParent,
                    l = !!b.categories, m = b.transA, x = b.isXAxis;
                if (x || l || d) {
                    var f = b.getClosest();
            ...
            e.prototype.setTickInterval = function (c) {
                var b = this, e = b.chart, g = b.logarithmic, k = b.options,
                    h = b.isXAxis, a = b.isLinked, m = k.maxPadding, x = k.minPadding, f = k.tickInterval,
                    p = k.tickPixelInterval, B = b.categories, A = l(b.threshold) ? b.threshold : null,
                    Q = b.softThreshold;
            ...
            e.prototype.setTickPositions = function () {
                ...
                var d = c.tickPositioner, g = this.hasVerticalPanning(), k = "colorAxis" === this.coll, h = (k ||
                    !g) && c.startOnTick;
                g = (k || !g) && c.endOnTick;
            ...
            e.prototype.trimTicks = function (c, b, e) {
                var d = c[0], g = c[c.length - 1], k = !this.isOrdinal && this.minPointOffset || 0;
                t(this, "trimTicks");
                if (!this.isLinked) {
                    if (b && -Infinity !== d) this.min = d; else for (; this.min - k > c[0];) c.shift();
                    if (e) this.max = g; else for (; this.max + k <
                                                     c[c.length - 1];) c.pop();
                    0 === c.length && q(d) && !this.options.tickPositions && c.push((g + d) / 2)
                }
            };
            e.prototype.alignToOthers = function () {
                var c = {}, b, e = this.options;
            ...
            e.prototype.adjustTickAmount = function () {
                var c = this.options, b = this.tickInterval, e = this.tickPositions, d = this.tickAmount,
                    g = this.finalTickAmt, k = e && e.length, h = r(this.threshold, this.softThreshold ? 0 : null), a;
                if (this.hasData()) {
                    if (k < d) {
            ...
            e.prototype.zoom = function (c, b) {
                var e = this, d = this.dataMin, g = this.dataMax, k = this.options, h = Math.min(d, r(k.min, d)),
                    a = Math.max(g,
                        r(k.max, g));
                c = {newMin: c, newMax: b};
                t(this, "zoom", c, function (b) {
                    var c = b.newMin, k = b.newMax;
            ...
            e.prototype.setAxisSize = function () {
                var c = this.chart, b = this.options, e = b.offsets || [0, 0, 0, 0], d = this.horiz,
            ...
            e.prototype.getThreshold = function (c) {
                var b = this.logarithmic, e = b ? b.lin2log(this.min) : this.min;
            ...
            e.prototype.tickSize = function (c) {
                var b =
                        this.options, e = b["tick" === c ? "tickLength" : "minorTickLength"],
            ...
            e.prototype.unsquish =
                function () {
                    var c = this.options.labels, b = this.horiz, e = this.tickInterval, d = e,
                        g = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), k, h = c.rotation,
                        a = this.labelMetrics(), l, m = Number.MAX_VALUE, x, f = this.max - this.min, p = function (b) {
                            var c = b / (g || 1);
                            c = 1 < c ? Math.ceil(c) : 1;
            ...
            e.prototype.getSlotWidth = function (c) {
                var b, e = this.chart, d = this.horiz, g = this.options.labels,
                    k = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), h = e.margin[3];
            ...
            e.prototype.renderUnsquish = function () {
                var c = this.chart, b = c.renderer, e = this.tickPositions, d = this.ticks, g = this.options.labels,
                    h = g && g.style || {}, a = this.horiz, l = this.getSlotWidth(),
                    m = Math.max(1, Math.round(l - 2 * (g.padding || 5))), r = {}, x = this.labelMetrics(),
                    f = g.style && g.style.textOverflow, p = 0;
                ...
                if (this.autoRotation) p > m && p > x.h ? r.rotation = this.labelRotation : this.labelRotation = 0; else if (l) {
                    ...
                    if (!f) {
                        ...
                        for (m = e.length; !a && m--;) {
                            var t = e[m];
                            if (t = d[t].label) t.styles && "ellipsis" === t.styles.textOverflow ? t.css({textOverflow: "clip"}) : t.textPxLength > l && t.css({width: l + "px"}), t.getBBox().height > this.len / e.length - (x.h - x.f) && (t.specificTextOverflow = "ellipsis")
                        }
                    }
                }
                ...
                if (this.labelAlign = g.align || this.autoLabelAlign(this.labelRotation)) r.align =
                    this.labelAlign;
                e.forEach(function (b) {
                    var c = (b = d[b]) && b.label, e = h.width, g = {};
            ...
            e.prototype.addTitle = function (c) {
                var b = this.chart.renderer, e = this.horiz, d = this.opposite, k = this.options.title, h,
            ...
            e.prototype.getOffset = function () {
                var c = this, b = c.chart, e = b.renderer, d = c.options, g = c.tickPositions, k = c.ticks, h = c.horiz,
                    a = c.side, l = b.inverted && !c.isZAxis ? [1, 0, 3, 2][a] : a, m, f = 0, p = 0, B = d.title,
                    A = d.labels, M = 0, F = b.axisOffset;
                b = b.clipOffset;
            ...
            e.prototype.getLinePath = function (c) {
                var b = this.chart, e = this.opposite, d = this.offset, g = this.horiz,
            ...
            e.prototype.getTitlePosition = function () {
                var c = this.horiz, b = this.left, e = this.top, d = this.len, g = this.options.title, k = c ? b : e,
                    h = this.opposite, a = this.offset, l = g.x || 0, m = g.y || 0, r = this.axisTitle,
            ...
            e.prototype.renderTick = function (c, b) {
                var e = this.isLinked, d = this.ticks, g = this.chart.hasRendered && l(this.oldMin);
                if (!e || c >=
                    this.min && c <= this.max) d[c] || (d[c] = new n(this, c)), g && d[c].isNew && d[c].render(b, !0, -1), d[c].render(b)
            };
            e.prototype.render = function () {
                var c = this, b = c.chart, e = c.logarithmic, d = c.options, g = c.isLinked, k = c.tickPositions,
                    h = c.axisTitle, m = c.ticks, r = c.minorTicks, f = c.alternateBands, p = d.stackLabels,
                    B = d.alternateGridColor, A = c.tickmarkOffset, Q = c.axisLine, F = c.showAxis,
                    u = C(b.renderer.globalAnimation), q, N;
            ...
            e.prototype.drawCrosshair = function (c,
                                                  b) {
                var e = this.crosshair, d = r(e.snap, !0), g, k = this.cross, h = this.chart;
                ...
                if (this.crosshair && !1 !== (q(b) || !d)) {
                    ...
                    k || (this.cross = k = h.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (d ? "category " : "thin ") + e.className).attr({zIndex: r(e.zIndex, 2)}).add(), h.styledMode || (k.attr({
                        stroke: e.color || (d ? f.parse("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
                        "stroke-width": r(e.width, 1)
                    }).css({"pointer-events": "none"}), e.dashStyle && k.attr({dashstyle: e.dashStyle})));
                    k.show().attr({d: a});
    ...
    O(n, "Core/Axis/LogarithmicAxis.js", [n["Core/Axis/Axis.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.addEvent, y = a.getMagnitude, D = a.normalizeTickInterval, G = a.pick, C = function () {
            ...
            a.prototype.getLogTickPositions = function (a, f, n, q) {
                ...
                if (.5 <= a) a = Math.round(a), t = v.getLinearTickPositions(a, f, n); else if (.08 <=
                    a) {
                    p = Math.floor(f);
                    var I, u;
        ...
        a = function () {
            ...
            a.compose = function (a) {
                ...
                var f = a.prototype, H = C.prototype;
                f.log2lin = H.log2lin;
                f.lin2log = H.lin2log;
                n(a, "init", function (a) {
        ...
        var y = n.arrayMax, D = n.arrayMin, G = n.defined, C = n.destroyObjectProperties, J = n.erase, H = n.extend,
            v = n.merge, L = n.objectEach, q = n.pick, K = function () {
                ...
                f.prototype.render = function () {
                    ...
                    var f = this, t = f.axis, I = t.horiz, u = t.logarithmic, m = f.options, h = m.label, l = f.label,
                        k = m.to, g = m.from, d = m.value, x = G(g) && G(k), r = G(d), A = f.svgElem, N = !A, B = [],
                        M = m.color, R = q(m.zIndex, 0), F = m.events;
        ...
        H(f.prototype, {
            getPlotBandPath: function (a, f) {
                var p = this.getPlotLinePath({value: f, force: !0, acrossPanes: this.options.acrossPanes}),
                    q = this.getPlotLinePath({value: a, force: !0, acrossPanes: this.options.acrossPanes}), u = [],
                    m = this.horiz, h = 1;
                ...
                var p =
                    (new K(this, a)).render(), q = this.userOptions;
                if (p) {
                    if (f) {
                        var u = q[f] || [];
                        u.push(a);
    ...
    O(n, "Core/Tooltip.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = f.doc, y = a.clamp, D = a.css, G = a.defined, C = a.discardElement, J = a.extend, H = a.fireEvent,
            v = a.format, L = a.isNumber, q = a.isString, K = a.merge, E = a.pick, p = a.splat, t = a.syncTimeout,
            I = a.timeUnits;
        "";
        var u = function () {
            function m(h, a) {
            ...
            m.prototype.getDateFormat = function (h, a, k, g) {
                var d = this.chart.time, l = d.dateFormat("%m-%d %H:%M:%S.%L",
                    a), f = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, m = "millisecond";
                for (p in I) {
            ...
            m.prototype.getLabel = function () {
                var h, a, k = this, g = this.chart.renderer, d = this.chart.styledMode, m = this.options,
                    r = "tooltip" + (G(m.className) ? " " + m.className : ""), p = (null === (h = m.style) ||
                ...
                if (!this.label) {
                    ...
                    if (k.outside && !k.split) {
                        var M = this.label, q = M.xSetter, F = M.ySetter;
            ...
            m.prototype.getPosition = function (a, l, k) {
                var g = this.chart, d = this.distance, h = {}, f = g.inverted && k.h || 0, m, p = this.outside,
                    ...
                    t = g.pointer.getChartPosition(), F = g.containerScaling, e = function (b) {
                    ...
                    }, z = b("y"), w = b("x"), q = !this.followPointer && E(k.ttBelow, !g.inverted === !!k.negative),
                    u = function (b, g, k, a, l, m, r) {
                        var x =
                                "y" === b ? c(d) : e(d), w = (k - a) / 2, p = a < l - d, B = l + d + a < g,
                            z = l - x - k + w;
                        l = l + x - w;
            ...
            m.prototype.refresh = function (h, l) {
                var k = this.chart, g = this.options, d = h, f = {}, m = [], A = g.formatter || this.defaultFormatter;
                f = this.shared;
                var t = k.styledMode;
                if (g.enabled) {
                    a.clearTimeout(this.hideTimer);
            ...
            m.prototype.renderSplit = function (a, l) {
                ...
                var g = this, d = g.chart, h = g.chart, m = h.plotHeight, p = h.plotLeft, t = h.plotTop, B = h.pointer,
                    M = h.renderer, u = h.scrollablePixelsY, F = void 0 === u ?
                        0 : u;
                u = h.scrollingContainer;
                u = void 0 === u ? {scrollLeft: 0, scrollTop: 0} : u;
                var e = u.scrollLeft, c = u.scrollTop, b = h.styledMode, z = g.distance, w = g.options,
                    v = g.options.positioner, n = {left: e, right: e + h.chartWidth, top: c, bottom: c + h.chartHeight},
                    I = g.getLabel(), H = !(!d.xAxis[0] || !d.xAxis[0].opposite), K = t + c, C = 0, G = m - F;
                q(a) && (a = [!1, a]);
                a = a.slice(0, l.length + 1).reduce(function (e, d, a) {
                    if (!1 !== d && "" !== d) {
                        a = l[a - 1] || {isHeader: !0, plotX: l[0].plotX, plotY: m, series: {}};
                        var h = a.isHeader, f = h ? g : a.series, r = f.tt, x = a.isHeader;
                        var B = a.series;
            ...
            m.prototype.drawTracker = function () {
                if (this.followPointer ||
                    ...
                    var a = this.chart, l = this.label, k = a.hoverPoint;
                    if (l && k) {
            ...
            m.prototype.tooltipFooterHeaderFormatter = function (a, l) {
                var k = l ? "footer" : "header", g = a.series, d = g.tooltipOptions, h = d.xDateFormat, f = g.xAxis,
                    m = f && "datetime" === f.options.type &&
                        L(a.key), p = d[k + "Format"];
            ...
            m.prototype.updatePosition =
                function (a) {
                    var h = this.chart, k = h.pointer, g = this.getLabel(), d = a.plotX + h.plotLeft,
                        f = a.plotY + h.plotTop;
    ...
    O(n, "Core/Pointer.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Tooltip.js"], n["Core/Utilities.js"]], function (f, a, n, y) {
        var D = f.parse, G = a.charts, C = a.noop, J = y.addEvent, H = y.attr, v = y.css, L = y.defined, q = y.extend,
            K = y.find, E = y.fireEvent, p = y.isNumber, t = y.isObject, I = y.objectEach, u = y.offset, m = y.pick,
            h = y.splat;
        "";
        f = function () {
            function l(a, g) {
            ...
            l.prototype.drag = function (a) {
                var g = this.chart, d = g.options.chart, k = a.chartX, h = a.chartY, l = this.zoomHor,
                    f = this.zoomVert, m = g.plotLeft, p = g.plotTop, u = g.plotWidth, F = g.plotHeight,
                    e = this.selectionMarker,
                    c = this.mouseDownX || 0, b = this.mouseDownY || 0,
                    z = t(d.panning) ? d.panning && d.panning.enabled : d.panning, w = d.panKey && a[d.panKey + "Key"];
            ...
            l.prototype.drop = function (a) {
                ...
                if (this.selectionMarker) {
                    var h = {originalEvent: a, xAxis: [], yAxis: []}, l = this.selectionMarker,
                        f = l.attr ? l.attr("x") : l.x, m = l.attr ? l.attr("y") : l.y,
                        t = l.attr ? l.attr("width") : l.width, u = l.attr ? l.attr("height") : l.height, F;
                    if (this.hasDragged || k) d.axes.forEach(function (e) {
                        if (e.zoomEnabled && L(e.min) && (k || g[{
                            xAxis: "zoomX",
                            yAxis: "zoomY"
                        }[e.coll]]) && p(f) && p(m)) {
                            var c = e.horiz, b = "touchend" === a.type ? e.minPixelPadding : 0,
                                d = e.toValue((c ? f : m) + b);
            ...
            l.prototype.getChartCoordinatesFromPoint = function (a, g) {
                var d = a.series, k = d.xAxis;
                d = d.yAxis;
                var h = m(a.clientX, a.plotX), l = a.shapeArgs;
                if (k && d) return g ? {
            ...
            l.prototype.pinch = function (a) {
                var g = this, d = g.chart, h = g.pinchDown, k = a.touches || [], l = k.length, f = g.lastValidTouch,
                    p = g.hasZoom, t = g.selectionMarker, u = {},
                ...
                "touchstart" === a.type ? ([].forEach.call(k, function (c, b) {
                    ...
                    if (c.zoomEnabled) {
                        var b = d.bounds[c.horiz ? "h" : "v"], e = c.minPixelPadding,
                            g = c.toPixels(Math.min(m(c.options.min, c.dataMin), c.dataMin)),
                            a = c.toPixels(Math.max(m(c.options.max, c.dataMax), c.dataMax)), h = Math.max(g, a);
            ...
            l.prototype.pinchTranslateDirection = function (a, g, d, h, l, f, m, p) {
                var k = this.chart, r = a ? "x" : "y", x = a ? "X" : "Y", e = "chart" + x, c = a ? "width" : "height",
                    b = k["plot" + (a ? "Left" : "Top")], B, w, t = p || 1, A = k.inverted, u = k.bounds[a ? "h" : "v"],
                    q = 1 === g.length, v = g[0][e], n = d[0][e], I = !q &&
                        g[1][e], N = !q && d[1][e];
                d = function () {
            ...
            l.prototype.runPointActions = function (h, g) {
                var d = this.chart, k = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0,
                    l = k ? k.shared : !1, f = g || d.hoverPoint, p = f && f.series || d.hoverSeries;
            ...
            l.prototype.setDOMEvents = function () {
                var h = this.chart.container, g = h.ownerDocument;
            ...
            l.prototype.setHoverChartIndex =
                function () {
                    var h = this.chart, g = a.charts[m(a.hoverChartIndex, -1)];
            ...
            l.prototype.touch = function (a, g) {
                var d = this.chart, h;
                this.setHoverChartIndex();
                if (1 === a.touches.length) if (a = this.normalize(a), (h = d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop)) && !d.openMenu) {
            ...
            l.prototype.zoomOption = function (a) {
                var g = this.chart, d = g.options.chart, h = d.zoomType || "";
                g = g.inverted;
    ...
    O(n, "Core/MSPointer.js", [n["Core/Globals.js"], n["Core/Pointer.js"], n["Core/Utilities.js"]], function (f, a,
        ...
        var G = this && this.__extends || function () {
            ...
            }(), C = f.charts, J = f.doc, H = f.noop, v = n.addEvent, L = n.css, q = n.objectEach, K = n.removeEvent,
            E = {}, p = !!f.win.PointerEvent;
        return function (a) {
            function f() {
    ...
    O(n, "Core/Legend.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.addEvent, y = a.animObject, D = a.css, G = a.defined, C = a.discardElement, J = a.find,
            H = a.fireEvent, v = a.format, L = a.isNumber, q = a.merge, K = a.pick, E = a.relativeLength,
            p = a.setAnimation, t = a.stableSort, I = a.syncTimeout;
        a = a.wrap;
        var u = f.isFirefox, m = f.marginNames, h = f.win, l = function () {
            ...
            a.prototype.colorizeItem = function (a, d) {
                ...
                if (!this.chart.styledMode) {
                    var g = this.options, h = a.legendItem, k = a.legendLine, f = a.legendSymbol,
                        l = this.itemHiddenStyle.color;
                    g = d ? g.itemStyle.color : l;
                    var m = d ? a.color || l : l, p = a.options && a.options.marker, t = {fill: m};
            ...
            a.prototype.positionItem = function (a) {
                var d = this, g = this.options, h = g.symbolPadding, k = !g.rtl, f = a._legendItemPos;
                g =
                    f[0];
                f = f[1];
                var l = a.checkbox, m = a.legendGroup;
                m && m.element && (h = {
            ...
            a.prototype.renderTitle = function () {
                var a = this.options, d = this.padding, h = a.title, k = 0;
            ...
            a.prototype.renderItem = function (a) {
                var d = this.chart, g = d.renderer, h = this.options, k = this.symbolWidth, f = h.symbolPadding,
                    l = this.itemStyle, m = this.itemHiddenStyle,
                    p = "horizontal" === h.layout ? K(h.itemDistance, 20) : 0, t = !h.rtl, e = a.legendItem,
                    c = !a.series, b = !c && a.series.drawLegendSymbol ? a.series : a, z = b.options;
                z = this.createCheckboxForItem && z && z.showCheckbox;
                p = k + f + p + (z ? 20 : 0);
                var w = h.useHTML, u = a.options.className;
                e || (a.legendGroup = g.g("legend-item").addClass("highcharts-" + b.type + "-series highcharts-color-" + a.colorIndex + (u ? " " + u : "") + (c ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = e = g.text("", t ? k + f : -f, this.baseline || 0, w), d.styledMode || e.css(q(a.visible ? l : m)), e.attr({
                    align: t ? "left" : "right",
                    zIndex: 2
            ...
            a.prototype.layoutItem = function (a) {
                var d = this.options, g = this.padding, h = "horizontal" === d.layout, k = a.itemHeight,
                    f = this.itemMarginBottom, l = this.itemMarginTop, m = h ? K(d.itemDistance, 20) : 0,
            ...
            a.prototype.adjustMargins = function (a, d) {
                var g = this.chart, h = this.options, k = this.getAlignment();
            ...
            a.prototype.proximatePositions = function () {
                var a = this.chart, d = [], h = "left" === this.options.align;
                this.allItems.forEach(function (g) {
                    var k;
                    var l = h;
                    if (g.yAxis) {
            ...
            a.prototype.render = function () {
                var a = this.chart, d = a.renderer, h = this.group, k = this.box, l = this.options, f = this.padding;
                this.itemX = f;
            ...
            a.prototype.align = function (a) {
                ...
                var d = this.chart, g = this.options, h = a.y;
            ...
            a.prototype.handleOverflow = function (a) {
                var d = this, g = this.chart, h = g.renderer, k = this.options, l = k.y, f = this.padding;
                l = g.spacingBox.height + ("top" === k.verticalAlign ? -l : l) - f;
                var m = k.maxHeight, p, t = this.clipRect, e = k.navigation, c = K(e.animation, !0),
                    b = e.arrowSize || 12, z = this.nav, w = this.pages, q, u = this.allItems, n = function (b) {
                ...
                a > l && !1 !== e.enabled ? (this.clipHeight = p = Math.max(l - 20 - this.titleHeight - f, 0), this.currentPage = K(this.currentPage, 1), this.fullHeight = a, u.forEach(function (b, c) {
                    ...
                    e !== q && (q = e)
                }), t || (t = d.clipRect = h.clipRect(0, f, 9999, 0), d.contentGroup.clip(t)), n(p), z || (this.nav = z = h.g().attr({zIndex: 1}).add(this.group), this.up = h.symbol("triangle", 0, 0, b, b).add(z), v("upTracker").on("click", function () {
                    d.scroll(-1, c)
                    ...
                    d.scroll(1, c)
                })), d.scroll(0), a = l) : z && (n(), this.nav = z.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            };
            a.prototype.scroll = function (a, d) {
                var g = this, h = this.chart, k = this.pages, l = k.length, f = this.currentPage + a;
                a = this.clipHeight;
                var m = this.options.navigation, t = this.pager, q = this.padding;
                f > l && (f = l);
                ...
                }), t.attr({text: f + "/" + l}), [this.down, this.downTracker].forEach(function (e) {
                    e.attr({
                        x: 18 + this.pager.getBBox().width,
                        "class": f === l ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                    })
                }, this), h.styledMode || (this.up.attr({fill: 1 === f ? m.inactiveColor : m.activeColor}), this.upTracker.css({
                    cursor: 1 === f ? "default" :
                        "pointer"
                }), this.down.attr({fill: f === l ? m.inactiveColor : m.activeColor}), this.downTracker.css({cursor: f === l ? "default" : "pointer"})), this.scrollOffset = -k[f - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = f, this.positionCheckboxes(), d = y(K(d, h.renderer.globalAnimation, !0)), I(function () {
    ...
    O(n, "Core/Chart/Chart.js", [n["Core/Axis/Axis.js"], n["Core/Globals.js"], n["Core/Legend.js"], n["Core/MSPointer.js"], n["Core/Options.js"], n["Core/Pointer.js"], n["Core/Time.js"], n["Core/Utilities.js"]], function (f, a, n, y, D, G, C, J) {
        var H = a.charts, v = a.doc, L = a.seriesTypes, q = a.win, K = D.defaultOptions, E = J.addEvent, p = J.animate,
            t = J.animObject, I = J.attr, u = J.createElement, m = J.css, h = J.defined, l = J.discardElement,
            k = J.erase, g = J.error, d = J.extend, x = J.find, r = J.fireEvent, A = J.getStyle, N = J.isArray,
            B = J.isFunction, M = J.isNumber, R = J.isObject, F = J.isString, e = J.merge, c = J.numberFormat,
            b = J.objectEach, z = J.pick, w = J.pInt, P = J.relativeLength, Z = J.removeEvent, W = J.setAnimation,
            aa = J.splat, X = J.syncTimeout, ba = J.uniqueKey, ca = a.marginNames, Y = function () {
                function D(b, c, e) {
                ...
                D.prototype.redraw = function (b) {
                    r(this, "beforeRedraw");
                    var c = this, e = c.axes, a = c.series, g = c.pointer, h = c.legend, k = c.userOptions.legend,
                        l = c.isDirtyLegend, f = c.hasCartesianSeries, m = c.isDirtyBox, p = c.renderer, w = p.isHidden(),
                        z = [];
                ...
                D.prototype.getAxes = function () {
                    var b = this, c = this.options, e = c.xAxis = aa(c.xAxis || {});
                ...
                D.prototype.layOutTitles = function (b) {
                    var c = [0, 0, 0], e = this.renderer, a = this.spacingBox;
                    ["title", "subtitle", "caption"].forEach(function (b) {
                        var g = this[b], h = this.options[b], k = h.verticalAlign || "top";
                        b =
                ...
                D.prototype.temporaryDisplay = function (b) {
                    var c = this.renderTo;
                    if (b) for (; c && c.style;) c.hcOrigStyle && (m(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (v.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode; else for (; c && c.style;) {
                ...
                D.prototype.getContainer = function () {
                    ...
                    if (this.styledMode) for (l in b.defs) this.renderer.definition(b.defs[l]); else this.renderer.setStyle(c.style);
                    this.renderer.chartIndex = this.index;
                    r(this, "afterGetContainer")
                };
                D.prototype.getMargins = function (b) {
                    var c = this.spacing, e = this.margin, d = this.titleOffset;
                    this.resetMargins();
                    d[0] &&
                ...
                D.prototype.getAxisMargins = function () {
                    var b = this, c = b.axisOffset = [0, 0, 0, 0], e = b.colorAxis, d = b.margin, a = function (b) {
                        b.forEach(function (b) {
                ...
                D.prototype.reflow = function (b) {
                    var c = this, e = c.options.chart, d = c.renderTo, a = h(e.width) && h(e.height),
                        g = e.width || A(d, "width");
                ...
                D.prototype.setChartSize = function (b) {
                    var c = this.inverted, e = this.renderer, d = this.chartWidth, a = this.chartHeight,
                        g = this.options.chart, h = this.spacing, k = this.clipOffset,
                        f, l, m, p;
                ...
                D.prototype.drawChartBox = function () {
                    var b = this.options.chart, c = this.renderer, e = this.chartWidth, d = this.chartHeight,
                        a = this.chartBackground, g = this.plotBackground, h = this.plotBorder, k = this.styledMode,
                        f = this.plotBGImage, l = b.backgroundColor, m = b.plotBackgroundColor, p = b.plotBackgroundImage,
                        w, z = this.plotLeft, t = this.plotTop, B = this.plotWidth, q = this.plotHeight, x = this.plotBox,
                ...
                D.prototype.propFromSeries = function () {
                    var b = this, c = b.options.chart, e, d = b.options.series, a, g;
                ...
                D.prototype.renderLabels = function () {
                    ...
                    c.items && c.items.forEach(function (e) {
                        var a = d(c.style, e.style), g = w(a.left) + b.plotLeft, h = w(a.top) + b.plotTop + 12;
                        delete a.left;
                        delete a.top;
                ...
                D.prototype.render = function () {
                    var b = this.axes, c = this.colorAxis, e = this.renderer, d = this.options, a = 0, g = function (b) {
                        b.forEach(function (b) {
                            b.visible && b.render()
                        })
                    };
                ...
                D.prototype.addCredits = function (b) {
                    var c =
                        this, d = e(!0, this.options.credits, b);
                ...
                D.prototype.updateContainerScaling = function () {
                    ...
                    if (2 < b.offsetWidth &&
                        ...
                        var c = b.getBoundingClientRect(), e = c.width / b.offsetWidth;
                        b = c.height / b.offsetHeight;
                        1 !== e || 1 !== b ? this.containerScaling = {scaleX: e, scaleY: b} : delete this.containerScaling
                    }
                };
                D.prototype.destroy = function () {
                    var c = this, e = c.axes, d = c.series, g = c.container, h, f = g && g.parentNode;
                    r(c, "destroy");
    ...
    O(n, "Extensions/ScrollablePlotArea.js", [n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a, n) {
        var y = n.addEvent, D = n.createElement, G = n.pick, C = n.stop;
        "";
        y(f, "afterSetChartSize", function (f) {
            var n = this.options.chart.scrollablePlotArea, v = n && n.minWidth;
            n = n && n.minHeight;
        ...
        f.prototype.setUpScrolling = function () {
            var a = this, f = {WebkitOverflowScrolling: "touch", overflowX: "hidden", overflowY: "hidden"};
        ...
        f.prototype.moveFixedElements = function () {
            var a = this.container, f = this.fixedRenderer,
        ...
        f.prototype.applyFixed = function () {
            var f, n, v = !this.fixedDiv, L = this.options.chart.scrollablePlotArea;
            ...
            v = this.scrollablePixelsX ?
                [["M", 0, v], ["L", this.plotLeft - 1, v], ["L", this.plotLeft - 1, n], ["L", 0, n], ["Z"], ["M", q, v], ["L", this.chartWidth, v], ["L", this.chartWidth, n], ["L", q, n], ["Z"]] : this.scrollablePixelsY ? [["M", L, 0], ["L", L, this.plotTop - 1], ["L", f, this.plotTop - 1], ["L", f, 0], ["Z"], ["M", L, K], ["L", L, this.chartHeight], ["L", f, this.chartHeight], ["L", f, K], ["Z"]] : [["M", 0, 0]];
        ...
        var a = f.addEvent, n = f.destroyObjectProperties,
            y = f.fireEvent, D = f.getDeferredAnimation, G = f.objectEach, C = f.pick, J = function () {
                ...
                a.prototype.buildStacks = function () {
                    var a = this.axis, f = a.series, q = C(a.options.reversedStacks, !0), n = f.length, E;
                    if (!a.isXAxis) {
                ...
                a.prototype.renderStackTotals = function () {
                    var a = this.axis, f = a.chart, q = f.renderer, n = this.stacks;
    ...
    O(n, "Mixins/LegendSymbol.js",
        [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
            var n = a.merge, y = a.pick;
            return f.LegendSymbolMixin = {
                drawRectangle: function (a, f) {
                    var n = a.symbolHeight, D = a.options.squareSymbol;
                    ...
                    var f = this.options, C = f.marker, D = a.symbolWidth, H = a.symbolHeight, v = H / 2,
                        L = this.chart.renderer, q =
                            this.legendGroup;
    ...
    O(n, "Core/Series/Point.js",
        [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
            var n = a.animObject, y = a.defined, D = a.erase, G = a.extend, C = a.fireEvent, J = a.format,
                H = a.getNestedProperty, v = a.isArray, L = a.isNumber, q = a.isObject, K = a.syncTimeout, E = a.pick,
                p = a.removeEvent, t = a.uniqueKey;
            "";
            a = function () {
                function a() {
                ...
                a.prototype.animateBeforeDestroy =
                    function () {
                        var a = this, f = {x: a.startXPos, opacity: 0}, h, l = a.getGraphicalProps();
                        ...
                        l.plural.forEach(function (h) {
                            a[h].forEach(function (g) {
                                g.element && g.animate(G({x: a.startXPos}, g.startYPos ? {
                                    x: g.startXPos,
                                    y: g.startYPos
                                } : {}))
                            })
                ...
                a.prototype.destroy =
                    function () {
                        ...
                        var f = this, h = f.series, l = h.chart;
                        h = h.options.dataSorting;
                        var k = l.hoverPoints, g = n(f.series.chart.renderer.globalAnimation), d;
                ...
                a.prototype.getGraphicalProps = function (a) {
                    var f = this, h = [], l, k = {singular: [], plural: []};
                ...
                a.prototype.optionsToObject = function (f) {
                    var m = {}, h = this.series, l = h.options.keys, k = l || h.pointArrayMap || ["y"], g = k.length,
                        d = 0, p = 0;
                    if (L(f) || null === f) m[k[0]] = f; else if (v(f)) for (!l && f.length > g && (h = typeof f[0], "string" === h ? m.name = f[0] : "number" === h && (m.x = f[0]), d++); p < g;) l && "undefined" === typeof f[d] || (0 < k[p].indexOf(".") ? a.prototype.setNestedProperty(m, f[d], k[p]) : m[k[p]] = f[d]), d++, p++; else "object" ===
                ...
                a.prototype.tooltipFormatter = function (a) {
                    var f = this.series, h = f.tooltipOptions, l = E(h.valueDecimals, ""), k = h.valuePrefix || "",
                        g = h.valueSuffix || "";
    ...
    O(n, "Core/Series/Series.js", [n["Core/Globals.js"], n["Mixins/LegendSymbol.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Utilities.js"]], function (f, a, n, y, D, G) {
        var C = n.defaultOptions, J = G.addEvent, H = G.animObject, v = G.arrayMax, L = G.arrayMin, q = G.clamp,
            K = G.correctFloat, E = G.defined, p = G.erase, t = G.error, I = G.extend, u = G.find, m = G.fireEvent,
            h = G.getNestedProperty,
            l = G.isArray, k = G.isFunction, g = G.isNumber, d = G.isString, x = G.merge, r = G.objectEach, A = G.pick,
            N = G.removeEvent;
        n = G.seriesType;
        ...
        f.Series = n("line", null, {
            ...
            bindAxes: function () {
                var e = this, c = e.options, b = e.chart, a;
            ...
            updateParallelArrays: function (e, c) {
                var b = e.series, a = arguments, d = g(c) ? function (a) {
            ...
            autoIncrement: function () {
                var e = this.options, c = this.xIncrement, b, a = e.pointIntervalUnit, d = this.chart.time;
            ...
            setOptions: function (e) {
                var c = this.chart, b = c.options, a = b.plotOptions, d = c.userOptions || {};
                e = x(e);
                c = c.styledMode;
                var g = {plotOptions: a, userOptions: e};
                m(this, "setOptions", g);
                var h = g.plotOptions[this.type], f = d.plotOptions || {};
            ...
            getCyclic: function (e, c, b) {
                var a = this.chart, d = this.userOptions, g = e + "Index", h = e + "Counter",
            ...
            findPointIndex: function (e, c) {
                ...
                -1 !== m && "undefined" !== typeof m && this.cropped && (m = m >= this.cropStart ?
                    m - this.cropStart : m);
            ...
            updateData: function (e, c) {
                var b = this.options, a = b.dataSorting, d = this.points, h = [], f, k, l, m = this.requireSorting,
                    p = e.length === d.length, r = !0;
                ...
                if (f) for (e = d.length; e--;) (k = d[e]) && !k.touched && k.remove && k.remove(!1, c); else !p || a && a.enabled ? r = !1 : (e.forEach(function (b, c) {
            ...
            setData: function (e, c, b, a) {
                var h = this, f = h.points, k = f && f.length || 0, m, p = h.options, r = h.chart, B = p.dataSorting,
                    z = null, n = h.xAxis;
                z = p.turboThreshold;
                var q = this.xData, x = this.yData, F = (m = h.pointArrayMap) && m.length, M = p.keys, v = 0, u = 1, I;
                e = e || [];
                m = e.length;
                c = A(c, !0);
            ...
            sortData: function (e) {
                var c = this, b = c.options.dataSorting.sortKey || "y", a = function (b, c) {
            ...
            getProcessedData: function (e) {
                var c = this.xData, b = this.yData, a = c.length;
                var d = 0;
                var g = this.xAxis, h = this.options;
                var f = h.cropThreshold;
                var k = e || this.getExtremesFromAll || h.getExtremesFromAll, l = this.isCartesian;
                e = g && g.val2lin;
                h = !(!g || !g.logarithmic);
                ...
                for (f = c.length || 1; --f;) if (a = h ? e(c[f]) - e(c[f - 1]) : c[f] - c[f - 1], 0 < a && ("undefined" === typeof n || a < n)) var n = a; else 0 > a && m && (t(15, !1, this.chart), m = !1);
            ...
            cropData: function (e, c, b, a, d) {
                var g = e.length, h = 0, f = g, k;
                d = A(d, this.cropShoulder);
                for (k = 0; k < g; k++) if (e[k] >= b) {
                    h = Math.max(0, k - d);
                    break
                }
                for (b = k; b < g; b++) if (e[b] > a) {
                    f = b + d;
                    break
                }
                return {
            ...
            generatePoints: function () {
                var e = this.options, c = e.data, b = this.data, a, d = this.processedXData, g = this.processedYData,
                    h = this.pointClass, f = d.length, k = this.cropStart || 0, l = this.hasGroupedData;
                e = e.keys;
                var p = [], r;
            ...
            getExtremes: function (e, c) {
                var b = this.xAxis, a = this.yAxis, d = this.processedXData || this.xData, h = [], f = 0, k = 0;
                var p = 0;
                var r = this.requireSorting ? this.cropShoulder : 0, t = a ? a.positiveValuesOnly :
                    !1, B;
                ...
                for (B = 0; B < a; B++) {
                    ...
                    if (x && n) if (x = q.length) for (; x--;) g(q[x]) && (h[f++] = q[x]); else h[f++] = q
                }
            ...
            translate: function () {
                ...
                this.generatePoints();
                var e = this.options, c = e.stacking, b = this.xAxis, a = b.categories, d = this.enabledDataSorting,
                    h = this.yAxis, f = this.points, k = f.length, p = !!this.modifyValue, r,
                    t = this.pointPlacementToXValue(), B = !!t, n = e.threshold, x = e.startFromThreshold ? n : 0, F,
                    M = this.zoneAxis || "y", v = Number.MAX_VALUE;
                for (r = 0; r <
                k; r++) {
                    var u = f[r], I = u.x, C = u.y, H = u.low,
            ...
            getClipBox: function (e, c) {
                var b = this.options, a = this.chart, d = a.inverted, g = this.xAxis, h = g && this.yAxis,
            ...
            setClip: function (e) {
                var c = this.chart, b = this.options, a = c.renderer, d = c.inverted, g = this.clipBox,
                    h = this.getClipBox(e),
                    f = this.sharedClipKey || ["_sharedClip", e && e.duration, e && e.easing, h.height,
                        b.xAxis, b.yAxis].join(), k = c[f], l = c[f + "m"];
            ...
            drawPoints: function () {
                var e = this.points, c = this.chart,
                    b, a, d = this.options.marker, g = this[this.specialGroup] || this.markerGroup, h = this.xAxis,
            ...
            markerAttribs: function (e, c) {
                var b = this.options,
                    a = b.marker, d = e.marker || {}, g = d.symbol || a.symbol, h = A(d.radius, a.radius);
            ...
            pointAttribs: function (e, c) {
                var b = this.options.marker, a = e && e.options, d = a && a.marker || {}, g = this.color,
                    h = a && a.color, f = e && e.color;
            ...
            destroy: function (e) {
                var c = this, b = c.chart, a = /AppleWebKit\/533/.test(F.navigator.userAgent), d, g, h = c.data || [],
                    f, k;
                m(c, "destroy");
                this.removeEvents(e);
            ...
            getGraphPath: function (e, c, b) {
                var a = this, d = a.options, g = d.step, h, f = [], k = [], l;
                e = e ||
                    a.points;
                ...
                e.forEach(function (h, m) {
                    var p = h.plotX, r = h.plotY, t = e[m - 1];
                    (h.leftCliff || t && t.rightCliff) && !b && (l = !0);
                    h.isNull && !E(c) && 0 < m ? l = !d.connectNulls : h.isNull && !c ? l = !0 : (0 === m || l ? m = [["M", h.plotX, h.plotY]] : a.getPointSpline ? m = [a.getPointSpline(e, h, m)] : g ? (m = 1 === g ? [["L", t.plotX, r]] : 2 === g ? [["L", (t.plotX + p) / 2, t.plotY], ["L", (t.plotX + p) / 2, r]] : [["L", p, t.plotY]], m.push(["L", p, r])) : m = [["L",
            ...
            drawGraph: function () {
                var e = this, c = this.options, b = (this.gappedPath || this.getGraphPath).call(this),
                    a = this.chart.styledMode, d = [["graph", "highcharts-graph"]];
                a || d[0].push(c.lineColor || this.color || "#cccccc", c.dashStyle);
                d = e.getZonesGraphs(d);
                d.forEach(function (d, g) {
                    var h = d[0], f = e[h], k = f ? "animate" : "attr";
            ...
            applyZones: function () {
                var a = this, c = this.chart, b = c.renderer, d = this.zones, g, h, f = this.clips || [], k,
                    l = this.graph, m = this.area, p = Math.max(c.chartWidth, c.chartHeight),
                    r = this[(this.zoneAxis || "y") + "Axis"], t = c.inverted, B, n, x, F = !1, u, M;
                if (d.length && (l || m) && r && "undefined" !== typeof r.min) {
                    ...
                    d.forEach(function (e, d) {
                        ...
                        t && b.isVML && (k = r.isXAxis ? {
                            ...
                            height: k.width,
                            width: c.chartWidth
                        } : {x: k.y - c.plotLeft - c.spacingBox.x, y: 0, width: k.height, height: c.chartHeight});
            ...
            render: function () {
                var a = this, c = a.chart, b = a.options, d = H(b.animation),
                    g = !a.finishedAnimating && c.renderer.isSVG && d.duration, h = a.visible ? "inherit" : "hidden",
                    f = b.zIndex, k = a.hasRendered, l = c.seriesGroup, p = c.inverted;
                m(this, "render");
            ...
            redraw: function () {
                var a = this.chart, c = this.isDirty || this.isDirtyData, b = this.group, d = this.xAxis,
                    g = this.yAxis;
                b && (a.inverted && b.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), b.animate({translateX: A(d && d.left, a.plotLeft), translateY: A(g && g.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchKDTree: function (a, c, b) {
                function d(b, c, a, k) {
                    var l = c.point, m = e.kdAxisArray[a % k], p = l;
                ...
                var e = this, g = this.kdAxisArray[0], h = this.kdAxisArray[1], f = c ? "distX" : "dist";
            ...
            pointPlacementToXValue: function () {
                var a = this.options, c = a.pointRange, b = this.xAxis;
                a = a.pointPlacement;
    ...
    O(n, "Extensions/Stacking.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Axis/StackingAxis.js"], n["Core/Utilities.js"]], function (f, a, n, y, D) {
        ...
        var q = n.Series, K = function () {
            ...
            a.prototype.render = function (a) {
                var f = this.axis.chart, p = this.options, n = p.format;
            ...
            a.prototype.getStackBox = function (a, f, n, q, m, h, l) {
                var k = f.axis.reversed,
                    g = a.inverted, d = l.height + l.pos - (g ? a.plotLeft : a.plotTop);
        ...
        q.prototype.setStackedPoints = function (a) {
            ...
            if (f && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var n =
                        this.processedXData, q = this.processedYData, u = [], m = q.length, h = this.options,
                    l = h.threshold, k = L(h.startFromThreshold && l, 0);
                h = h.stack;
                a = a ? this.type + "," + f : this.stackKey;
                var g = "-" + a, d = this.negStacks, x = this.yAxis, r = x.stacking.stacks, A = x.stacking.oldStacks, v,
                    B;
        ...
        q.prototype.modifyStacks = function () {
            var a = this, f = a.stackKey, n = a.yAxis.stacking.stacks, q = a.processedXData, v, m = a.options.stacking;
    ...
    O(n, "Core/Dynamics.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Time.js"],
        ...
        var J = y.time, H = C.addEvent, v = C.animate, L = C.createElement, q = C.css, K = C.defined, E = C.erase,
            p = C.error, t = C.extend, I = C.fireEvent, u = C.isArray, m = C.isNumber, h = C.isObject, l = C.isString,
            k = C.merge, g = C.objectEach, d = C.pick, x = C.relativeLength, r = C.setAnimation, A = C.splat;
        y = n.Series;
        var N = n.seriesTypes;
        ...
        t(a.prototype, {
            ...
            createAxis: function (a,
                                  g) {
                var h = this.options, l = "colorAxis" === a, e = g.redraw, c = g.animation;
            ...
            showLoading: function (a) {
                ...
                g.styledMode || (q(f, t(e.style, {zIndex: 10})), q(g.loadingSpan, e.labelStyle), g.loadingShown || (q(f, {
                    opacity: 0,
                    display: ""
                }), v(f, {opacity: e.style.opacity || .5}, {duration: e.showDuration || 0})));
                g.loadingShown =
                    !0;
                c()
            },
            hideLoading: function () {
                ...
                d && (d.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || v(d, {opacity: 0}, {
            ...
            update: function (a, h, f, p) {
                var e = this,
                    c = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle", caption: "setCaption"}, b,
                    r, q, t = a.isResponsiveOptions, B = [];
        ...
        t(D.prototype, {
            update: function (a, g, f, k) {
                ...
                var c = this, b = c.series, l = c.graphic, m, p = b.chart, r = b.options;
                g = d(g, !0);
        ...
        t(y.prototype, {
            addPoint: function (a, g, h, f, e) {
                var c = this.options, b = this.data, k = this.chart, l = this.xAxis;
                ...
                var f = this, e = f.data, c = e[a], b = f.points, k = f.chart, l = function () {
                ...
                var h = this, f = h.chart, e = h.userOptions, c = h.initialType || h.type,
                    ...
                    m = N[c].prototype, r, q = ["eventOptions", "navigatorSeries", "baseSeries"],
        ...
        a("area", "line", {threshold: 0}, {
            singleStacks: !1, getStackPoints: function (a) {
                var f = [], n = [], q = this.xAxis, H = this.yAxis, E = H.stacking.stacks[this.stackKey],
                    p = {}, t = this.index, I = H.series, u = I.length, m = C(H.options.reversedStacks, !0) ? 1 : -1, h;
                a = a || this.points;
                if (this.options.stacking) {
                    ...
                    n.forEach(function (a, g) {
                        ...
                        if (p[a] && !p[a].isNull) f.push(p[a]), [-1, 1].forEach(function (d) {
                            var f = 1 === d ? "rightNull" : "leftNull", q = 0, x = E[n[g + d]];
                            if (x) for (h = t; 0 <= h && h < u;) k = x.points[h],
                ...
                var f = J.prototype.getGraphPath, n = this.options, q = n.stacking, y = this.yAxis, E, p = [], t = [],
                    I = this.index, u = y.stacking.stacks[this.stackKey], m = n.threshold,
                ...
                var l = function (d, f, k) {
                    ...
                    "undefined" !== typeof n && (t.push({
                        ...
                        isNull: l,
                        isCliff: !0
                    }), p.push({plotX: g, plotY: null === x ? h : y.getThreshold(x), doCurve: !1}))
                };
                a = a || this.points;
                ...
                var a = this, f = this.areaPath, n = this.options, q = [["area", "highcharts-area",
                ...
                q.forEach(function (q) {
                    var v = q[0], p = a[v], t = p ? "animate" : "attr", I = {};
    ...
    O(n, "Series/SplineSeries.js", [n["Core/Utilities.js"]], function (f) {
        ...
        f("spline", "line", {}, {
            getPointSpline: function (f, n, D) {
                var y = n.plotX || 0, C = n.plotY || 0, J = f[D - 1];
                D = f[D + 1];
    ...
    O(n, "Series/ColumnSeries.js", [n["Core/Globals.js"], n["Core/Color.js"], n["Mixins/LegendSymbol.js"], n["Core/Utilities.js"]], function (f, a, n, y) {
        "";
        var D = a.parse, G = y.animObject, C = y.clamp, J = y.defined, H = y.extend, v = y.isNumber, L = y.merge,
            q = y.pick;
        a = y.seriesType;
        ...
        a("column", "line", {
            ...
            getColumnMetrics: function () {
                var a = this, f = a.options, n = a.xAxis, v = a.yAxis, m = n.options.reversedStacks;
                m = n.reversed && !m || !n.reversed && m;
                var h, l = {}, k = 0;
                !1 === f.grouping ? k = 1 : a.chart.series.forEach(function (d) {
                    var g = d.yAxis, f = d.options;
                ...
                var g = Math.min(Math.abs(n.transA) * (n.ordinal && n.ordinal.slope || f.pointRange || n.closestPointRange || n.tickInterval || 1), n.len),
                    d = g * f.groupPadding, x = (g - 2 * d) / (k || 1);
            ...
            crispCol: function (a, f, n, q) {
                var m = this.chart, h = this.borderWidth, l = -(h % 2 ? .5 : 0);
                h = h % 2 ? .5 : 1;
                ...
                if (!q.isNull && 1 < v.columnCount) {
                    ...
                    K(this.yAxis.stacking && this.yAxis.stacking.stacks, function (a) {
                        if ("number" === typeof q.x && (a = a[q.x.toString()])) {
                            var d = a.points[m.index], g = a.total;
            ...
            translate: function () {
                var a = this, f = a.chart, n = a.options, u = a.dense = 2 > a.closestPointRange * a.xAxis.transA;
                u = a.borderWidth = q(n.borderWidth, u ? 0 : 1);
                var m = a.xAxis, h = a.yAxis, l = n.threshold, k = a.translatedThreshold = h.getThreshold(l),
                    g = q(n.minPointLength, 5), d = a.getColumnMetrics(), x = d.width,
                    r = a.barW = Math.max(x, 1 + 2 * u), A = a.pointXOffset = d.offset, y = a.dataMin, B = a.dataMax;
                f.inverted && (k -= .5);
                ...
                a.points.forEach(function (p) {
                    ...
                    var b = c + A, u = r, w = Math.min(F, t), E = Math.max(F, t) - w;
                    if (g && Math.abs(E) < g) {
                        E = g;
            ...
            pointAttribs: function (a, f) {
                var p = this.options, n = this.pointAttrToOptions || {};
                var m = n.stroke || "borderColor";
                var h = n["stroke-width"] || "borderWidth", l = a && a.color || this.color,
                    k = a && a[m] || p[m] || this.color || l, g = a && a[h] || p[h] || this[h] || 0;
            ...
            drawPoints: function () {
                var a = this, f = this.chart, n = a.options, q = f.renderer, m = n.animationLimit || 250, h;
                a.points.forEach(function (l) {
                    var k = l.graphic, g = !!k, d = k && f.pointCount < m ? "animate" : "attr";
            ...
            animate: function (a) {
                var f = this, p = this.yAxis, n = f.options, m = this.chart.inverted, h = {},
                    l = m ? "translateX" : "translateY";
                if (a) h.scaleY = .001, a = C(p.toPixels(n.threshold),
                    p.pos, p.pos + p.len), m ? h.translateX = a - p.len : h.translateY = a, f.clipBox && f.setClip(), f.group.attr(h); else {
                    var k = f.group.attr(l);
                    f.group.animate({scaleY: 1}, H(G(f.options.animation), {
                        step: function (a, d) {
    ...
    O(n, "Series/ScatterSeries.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        ...
        a("scatter", "line", {
            ...
            sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group",
                ...
                var a = this, f = this.options.jitter, n = this.points.length;
    ...
    O(n, "Mixins/CenteredSeries.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.isNumber, y = a.pick, D = a.relativeLength, G = f.deg2rad;
        return f.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, n = this.chart, H = 2 * (a.slicedOffset || 0), v = n.plotWidth - 2 * H,
                    G = n.plotHeight - 2 * H, q = a.center, K = Math.min(v, G), E = a.size, p = a.innerSize || 0;
    ...
    O(n, "Series/PieSeries.js", [n["Core/Globals.js"], n["Core/Renderer/SVG/SVGRenderer.js"], n["Mixins/LegendSymbol.js"],
        ...
        var C = D.addEvent, J = D.clamp, H = D.defined, v = D.fireEvent, L = D.isNumber, q = D.merge, K = D.pick,
            E = D.relativeLength, p = D.seriesType, t = D.setAnimation, I = G.getStartAndEndRadians;
        D = f.noop;
        var u = f.Series;
        p("pie", "line", {
            center: [null, null],
            ...
            animate: function (a) {
                var f =
                    this, l = f.points, k = f.startAngleRad;
                a || l.forEach(function (a) {
                    var d = a.graphic, g = a.shapeArgs;
                    d && g && (d.attr({
                        r: K(a.startR, f.center && f.center[3] / 2),
                        start: k,
                        end: k
                    }), d.animate({r: g.r, start: g.start, end: g.end}, f.options.animation))
                })
            },
            hasData: function () {
            ...
            updateTotals: function () {
                var a, f = 0, l = this.points, k = l.length, g = this.options.ignoreHiddenPoint;
                for (a = 0; a < k; a++) {
                    var d = l[a];
            ...
            translate: function (a) {
                this.generatePoints();
                var f = 0, l = this.options, k = l.slicedOffset, g = k + (l.borderWidth || 0),
                    d = I(l.startAngle, l.endAngle), m = this.startAngleRad =
                        d.start;
                d = (this.endAngleRad = d.end) - m;
                var n = this.points, p = l.dataLabels.distance;
            ...
            drawEmpty: function () {
                var f = this.startAngleRad, h = this.endAngleRad, l = this.options;
            ...
            redrawPoints: function () {
                var a = this, f = a.chart, l = f.renderer, k, g, d, n, p = a.options.shadow;
                this.drawEmpty();
            ...
            init: function () {
                ...
                fixedOffset: function (a, f, l) {
                    ...
                    f = f.touchingSliceAt;
                    var h =
                        this.series, g = h.center[0], d = h.chart.plotWidth, m = h.chart.plotLeft;
                    h = a.alignment;
                ...
                var a = this.labelPosition, f = this.series.options.dataLabels, l = f.connectorShape,
    ...
    O(n, "Core/Series/DataLabels.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = f.noop, y = f.seriesTypes, D = a.arrayMax, G = a.clamp, C = a.defined, J = a.extend, H = a.fireEvent,
            v = a.format, L = a.getDeferredAnimation, q = a.isArray, K = a.merge, E = a.objectEach, p = a.pick,
            t = a.relativeLength, I = a.splat, u = a.stableSort, m = f.Series;
        f.distribute = function (a, l, k) {
            ...
            for (a = a.map(function (a) {
                return {size: a.size, targets: [a.target], align: p(a.align, .5)}
            }); h;) {
        ...
        m.prototype.drawDataLabels = function () {
            ...
            function f(a, d) {
                ...
                if (q(a) && !q(d)) c = a.map(function (a) {
                    ...
                    return K(a, b)
                }); else if (q(a) || q(d)) for (b = Math.max(a.length, d.length); b--;) c[b] = K(a[b], d[b]); else c = K(a, d);
                return c
            }

            var k = this, g = k.chart, d = k.options, m = d.dataLabels, n = k.points, t, u = k.hasRendered || 0,
                B = m.animation;
                ...
                n.forEach(function (h) {
                    ...
                    t.forEach(function (e, c) {
                        var b = e.enabled && (!h.isNull || h.dataLabelOnNull) && a(h, e),
                            ...
                            l = h.connectors ? h.connectors[c] : h.connector, m = p(e.distance, h.labelDistance),
                            n = !f;
                        if (b) {
        ...
        m.prototype.alignDataLabel = function (a, f, k, g, d) {
            var h = this, l = this.chart, m = this.isCartesian && l.inverted, n = this.enabledDataSorting,
                q = p(a.dlBox && a.dlBox.centerX, a.plotX, -9999), t = p(a.plotY, -9999), v = f.getBBox(),
                u = k.rotation,
                e = k.align, c = l.isInsidePlot(q, Math.round(t), m),
            ...
            if (z) {
                ...
                u ? (b = !1, q = l.renderer.rotCorr(y,
                    ...
                    y: g.y + (k.y || 0) + {top: 0, middle: .5, bottom: 1}[k.verticalAlign] * g.height
                }, w(q), f[d ? "attr" : "animate"](q).attr({align: e}), w = (u + 720) % 360, w = 180 < w && 360 > w, "left" === e ? q.y -= w ? v.height : 0 : "center" === e ? (q.x -= v.width / 2, q.y -= v.height / 2) : "right" === e && (q.x -= v.width, q.y -= w ? 0 : v.height), f.placed = !0, f.alignAttr = q) : (w(g), f.align(k, null, g), q = f.alignAttr);
        ...
        m.prototype.setDataLabelStartPos = function (a, f, k, g, d) {
            var h = this.chart, l = h.inverted, m = this.xAxis, n = m.reversed, p = l ? f.height / 2 : f.width / 2;
        ...
        m.prototype.justifyDataLabel = function (a, f, k, g, d, m) {
            var h = this.chart, l = f.align, n = f.verticalAlign, p = a.box ? 0 : a.padding || 0, q = f.x;
            q = void 0 === q ? 0 : q;
            var t = f.y;
            var x = void 0 === t ? 0 : t;
            t = k.x + p;
            ...
            t = k.y + p;
            0 > t && ("bottom" === n && 0 <= x ? (f.verticalAlign = "top", f.inside =
                !0) : x -= t, e = !0);
            t = k.y + g.height - p;
        ...
        y.pie && (y.pie.prototype.dataLabelPositioners = {
            ...
            var a = this, l = a.data, k, g = a.chart, d = a.options.dataLabels || {}, n = d.connectorPadding, r,
                q = g.plotWidth, t = g.plotHeight, v = g.plotLeft, u = Math.round(g.chartWidth / 3), y, F = a.center,
                e = F[2] / 2, c = F[1], b, z, w, E, H = [[], []], G, I, J, L, O = [0, 0, 0, 0],
                S = a.dataLabelPositioners, V;
            ...
            this.points.forEach(function (a) {
                ...
                }), f.shortened = !0), f.attr(f._attr), f[f.moved ? "animate" : "attr"](h), f.moved = !0) : f && f.attr({y: -9999}));
                delete a.distributeBox
            }, this)
        }, y.pie.prototype.alignDataLabel =
            n, y.pie.prototype.verifyDataLabelOverflow = function (a) {
            var f = this.center, h = this.options, g = h.center, d = h.minSize || 80, m = null !== h.size;
            if (!m) {
        ...
        y.column && (y.column.prototype.alignDataLabel =
            function (a, f, k, g, d) {
                var h = this.chart.inverted, l = a.series, n = a.dlBox || a.shapeArgs,
    ...
    O(n, "Extensions/OverlappingDataLabels.js", [n["Core/Chart/Chart.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.addEvent, y = a.fireEvent, D = a.isArray, G = a.isNumber, C = a.objectEach, J = a.pick;
        n(f, "render", function () {
            var a = [];
        ...
        f.prototype.hideOverlappingLabels = function (a) {
            var f = this, n = a.length, q = f.renderer, C, E, p, t = !1;
            var D = function (a) {
                var f, h = a.box ? 0 : a.padding || 0, g = f = 0, d;
    ...
    O(n, "Core/Interaction.js", [n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Legend.js"], n["Core/Options.js"],
        ...
        var C = y.defaultOptions, J = G.addEvent, H = G.createElement, v = G.css, L = G.defined, q = G.extend,
            K = G.fireEvent, E = G.isArray, p = G.isFunction, t = G.isNumber, I = G.isObject, u = G.merge,
            m = G.objectEach, h = G.pick, l = a.hasTouch;
        y = a.Series;
        G = a.seriesTypes;
        var k = a.svg;
        var g = a.TrackerMixin = {
            drawTrackerPoint: function () {
                var a = this, f = a.chart, g = f.pointer, h = function (a) {
            ...
            drawTrackerGraph: function () {
                var a = this, f = a.options, g = f.trackByArea, h = [].concat(g ? a.areaPath : a.graphPath),
                    m = a.chart, n = m.pointer, p = m.renderer, q = m.options.tooltip.snap, t = a.tracker,
                    e = function (b) {
                        if (m.hoverSeries !== a) a.onMouseOver()
                    }, c = "rgba(192,192,192," + (k ? .0001 : .002) + ")";
                t ? t.attr({d: h}) : a.graph && (a.tracker = p.path(h).attr({
        ...
        q(n.prototype, {
            setItemEvents: function (a, f, g) {
                var d = this, h = d.chart.renderer.boxWrapper, k = a instanceof D,
                    l = "highcharts-legend-" + (k ? "point" : "series") + "-active", m = d.chart.styledMode;
        ...
        q(f.prototype, {
            showResetZoom: function () {
                ...
                var f = this, g = C.lang, h = f.options.chart.resetZoomButton, k = h.theme, l = k.states,
                ...
                var d = this, f, g = d.pointer, k = !1, l = d.inverted ? g.mouseDownX : g.mouseDownY;
                !a || a.resetSelection ? (d.axes.forEach(function (a) {
                    ...
                    var h = a.axis, e = d.inverted ? h.left : h.top, c = d.inverted ?
                        e + h.width : e + h.height, b = h.isXAxis, m = !1;
                ...
                var g = this, h = g.hoverPoints, k = g.options.chart,
                    l = g.options.mapNavigation && g.options.mapNavigation.enabled, m;
                ...
                K(this, "pan", {originalEvent: d}, function () {
                    ...
                    f.forEach(function (e) {
                        var c = g[e ? "xAxis" : "yAxis"][0], b = c.horiz, f = d[b ? "chartX" : "chartY"];
                        b = b ? "mouseDownX" : "mouseDownY";
                        var h = g[b], k = (c.pointRange || 0) / 2,
                            p = c.reversed && !g.inverted || !c.reversed && g.inverted ? -1 : 1, q = c.getExtremes(),
                            r = c.toValue(h - f, !0) + k * p;
                        p = c.toValue(h + c.len - f, !0) - k * p;
                        var u = p < r;
                        h = u ? p : r;
                        r = u ? r : p;
                        var v = c.hasVerticalPanning(), x = c.panningState;
        ...
        q(D.prototype, {
            select: function (a, f) {
                var d = this, g = d.series, k = g.chart;
                ...
                var d = this.series.chart, f = d.pointer;
                ...
                if (!this.hasImportedEvents) {
                    var a = this, f = u(a.series.options.point, a.options).events;
                    a.events = f;
                    m(f, function (d, f) {
                        p(d) && J(a, f, d)
                    });
                ...
                var d = this.series, g = this.state, k = d.options.states[a || "normal"] ||
                        {}, l = C.plotOptions[d.type].marker && d.options.marker, m = l && !1 === l.enabled,
                    n = l && l.states && l.states[a || "normal"] || {}, p = !1 === n.enabled, e = d.stateMarkerGraphic,
                    c = this.marker || {}, b = d.chart, t = d.halo, u, v = l && d.markerAttribs;
                a = a || "";
        ...
        q(y.prototype, {
            onMouseOver: function () {
                ...
                var a = this.options, f = this.chart, g = f.tooltip, h = f.hoverPoint;
                f.hoverSeries = null;
                if (h) h.onMouseOut();
                ...
                if (d.state !== a && ([d.group, d.markerGroup, d.dataLabelsGroup].forEach(function (c) {
                    ...
                    if (k && !k.dashstyle) for (m = {"stroke-width": n}, k.animate(m, e); d["zone-graph-" + g];) d["zone-graph-" +
                    g].attr(m), g += 1;
                ...
                var d = this, g = d.chart, h = d.legendItem, k = g.options.chart.ignoreHiddenSeries, l = d.visible;
                var m = (d.visible = a = d.options.visible = d.userOptions.visible = "undefined" === typeof a ? !l : a) ? "show" : "hide";
                ["group", "dataLabelsGroup",
                    "markerGroup", "tracker", "tt"].forEach(function (a) {
                    if (d[a]) d[a][m]()
                });
    ...
    O(n, "Core/Responsive.js", [n["Core/Chart/Chart.js"], n["Core/Utilities.js"]], function (f, a) {
        var n = a.find, y = a.isArray, D = a.isObject, G = a.merge, C = a.objectEach, J = a.pick, H = a.splat,
            v = a.uniqueKey;
        f.prototype.setResponsive = function (a, f) {
            var q = this.options.responsive, y = [], p = this.currentResponsive;
